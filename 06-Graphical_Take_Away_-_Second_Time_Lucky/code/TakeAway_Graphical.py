...
window.onkey(startGame, "s")
window.onkey(playerMove1, "1")
window.onkey(playerMove2, "2")
window.onkey(playerMove3, "3")
window.onkey(playerKeyN, "n")
window.onkey(playerKeyY, "y")
