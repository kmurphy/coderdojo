...
window.title("Happy Christmas from CoderDojo Tramore!") 
...
text.setposition(80, 120) 
text.color("dark green") 
text.write("CoderDojo", font=("Avenir", 30, "bold"), align="right") 
text.color("black") 
text.write("Tramore", font=("Avenir", 30, "normal"), align="left") 
