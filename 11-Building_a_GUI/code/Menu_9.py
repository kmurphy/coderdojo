...
def onclick(mx,my):
    ...
    for b in bob.buttons:
        if (b.x-b.w/2 <= mx <= b.x+b.w/2) and (b.y<=my<=b.y+b.h):
            ...
            if b.label=="Press Me":
               print("Hey you pressed the first button")
            elif b.label=="No Press Me":
                print("I'm in the middle, like Golddielocks")
            elif b.label=="Forget them, PRESS ME":
                print("I'm button 3")
            else:
                print("Unknown button. label = %s" % b.label)
